<?php get_header(); ?>
			...
			<div id="content">
				...
				<div id="inner-content" class="wrap cf">
					...
					<main id="main" class="custom_single_position m-all t-2of3 d-5of7 cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">

						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							
							<article id="post-<?php the_ID(); ?>" <?php post_class('cf'); ?> role="article">

 								<header class="custom_article_header article-header">
								...
								<section class="custom_article_content entry-content cf">
									<?php
